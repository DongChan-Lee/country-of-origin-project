...
- 한국데이터산업진흥원(K-data)과 과학기술정보통신부가 주최 및 주관하는 `2020 데이터 청년 캠퍼스` 과정에서 `1등 (경상남도지사상)`
- 대학별 우승팀 간 결선인 `2020 데이터 청년 캠퍼스 우수 프로젝트 발표`에서 `한국데이터산업진흥원장상 수상`
- "국립농산물품질관리원"과의 협력으로 진행했던 프로젝트
